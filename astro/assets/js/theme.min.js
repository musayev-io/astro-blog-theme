...
jQuery(document).ready(function(){"use strict";function e(e){return!("undefined"==typeof ecko_theme_config||!ecko_theme_config.hasOwnProperty(e)||""===ecko_theme_config[e])&&ecko_theme_config[e]}function t(){jQuery(".postcontents").fitVids()}function o(){jQuery("pre code").each(function(e,t){hljs.highlightBlock(t)})}function i(){jQuery(".postauthors-items").children().length<=1&&jQuery(".postauthors").remove()}function n(){("Microsoft Internet Explorer"==navigator.appName||navigator.userAgent.match(/Trident/)||navigator.userAgent.match(/rv:11/)||void 0!==jQuery.browser&&1==jQuery.browser.msie)&&void 0!==svg4everybody()&&svg4everybody()}function s(){new ClipboardJS(".postshare-item-permalink a"),jQuery(".postshare-item-permalink a").on("click",function(e){jQuery(".postshare-item-tooltip").css("opacity","1.0"),setTimeout(function(){jQuery(".postshare-item-tooltip").css("opacity","0.0")},3e3),e.preventDefault()})}function r(){jQuery(".postcontents").readingTime()}function a(){e("social_instagram")&&(jQuery(".social-instagram").attr("href",e("social_instagram")),jQuery(".social-instagram").show()),e("social_github")&&(jQuery(".social-github").attr("href",e("social_github")),jQuery(".social-github").show()),e("social_linkedin")&&(jQuery(".social-linkedin").attr("href",e("social_linkedin")),jQuery(".social-linkedin").show())}function u(){document.querySelectorAll(".kg-gallery-image img").forEach(function(e){var t=e.closest(".kg-gallery-image"),o=e.attributes.width.value,i=e.attributes.height.value,n=o/i;t.style.flex=n+" 1 0%"})}function c(){e("disqus_id")&&jQuery(".postcomments").css("display","block")}function l(e,t){var o=document,i=o.createElement("script");i.src="https://"+ecko_theme_config.disqus_id+".disqus.com/embed.js",console.log(i.src),i.setAttribute("data-timestamp",+new Date),(o.head||o.body).appendChild(i)}function p(){e("google_analytics_id")&&jQuery.getScript("https://www.googletagmanager.com/gtag/js?id="+ecko_theme_config.google_analytics_id,function(){function e(){dataLayer.push(arguments)}window.dataLayer=window.dataLayer||[],e("js",new Date),e("config",ecko_theme_config.google_analytics_id)})}function d(){jQuery(".navigation").hasClass("navigation__open")?jQuery(document).unbind("mouseup",g):jQuery(document).bind("mouseup",g),jQuery(".navigation").toggleClass("navigation__open"),jQuery(".navigation-icon").toggleClass("navigation-icon__active"),jQuery(".navigation-main").toggleClass("navigation-main__active")}function y(){var e=jQuery(".postflow-readtime"),t=100*jQuery(window).scrollTop()/(jQuery(".postcontents").height()+280-jQuery(window).height()+jQuery(".postcontents").offset().top),o=360*t/100;o>360&&(o=360),t>50?e.addClass("postflow-readtime-gt-50"):e.removeClass("postflow-readtime-gt-50"),jQuery(".postflow-readtime-progress-fill").css("transform","rotate("+o+"deg)")}!function(){t(),o(),i(),c(),p(),s(),r(),a(),u()}(),jQuery(window).load(function(){n()}),jQuery(".postcomments-view").on("click",function(){var e=jQuery(".postcomments").data("page-url"),t=jQuery(".postcomments").data("page-id");jQuery(".postcomments-view").hide(),jQuery(".postcomments-disqus").css("display","block"),l(e,t)});var f=jQuery(".subscribe-form");f.submit(function(e){if(""===jQuery(".subscribe-input").val())return void e.preventDefault();jQuery.ajax({type:f.attr("method"),url:f.attr("action"),data:f.serialize(),success:function(e){jQuery(".subscribe-submit").addClass("subscribe-submit__success"),jQuery(".subscribe-input").val("").attr("placeholder",jQuery(".subscribe-submit").data("success-input"))},error:function(e){}}),e.preventDefault()}),jQuery(".navigation-button").on("click",function(){d()});var g=function(e){jQuery(".navigation");jQuery(".navigation").is(e.target)||0!==jQuery(".navigation").has(e.target).length||(d(),jQuery(document).unbind("mouseup",g))},m=!1,j=!0;jQuery(".postmain").waypoint(function(e){"down"==e?(j=!1,m||(jQuery(".postflow").addClass("postflow__visible"),jQuery(".postreadingtime").addClass("postreadingtime__visible"))):(j=!0,jQuery(".postflow").removeClass("postflow__visible"),jQuery(".postreadingtime").removeClass("postreadingtime__visible"))},{offset:"130px"}),jQuery(".postfooter").waypoint(function(e){"down"==e?(m=!0,jQuery(".postreadingtime").removeClass("postreadingtime__visible")):(m=!1,jQuery(".postreadingtime").addClass("postreadingtime__visible"))},{offset:"100%"});if(jQuery(".postcontents").length){var Q=[];jQuery(".postcontents h1, .postcontents h2, .postcontents h3").waypoint(function(e){var t=jQuery(this);"down"===e&&jQuery(".postflow .postflow-current").fadeOut(200,function(){Q.push(jQuery(".postflow .postflow-current").text()),jQuery(this).text(t[0].element.innerText).fadeIn(200)}),"up"===e&&jQuery(".postflow .postflow-current").fadeOut(200,function(){jQuery(this).text(Q.pop()).fadeIn(200)})})}if(jQuery(".postcover-arrow").on("click",function(){jQuery("html, body").animate({scrollTop:jQuery(".postcover").height()},600)}),jQuery(".postflow-readtime").length){var h=!1;jQuery(window).scroll(function(){h=!0}),setInterval(function(){h&&(y(),h=!1)},500)}});